...
from graph_text_model import CCAModel, GraphLabelingModel, GraphModel, ProjTaskModel, TaskModel, TextModel
...
if __name__ == '__main__':
    ...
    def learn_one_fold(data):
        ...
        print('train size: {}, test size: {}, val size: {}'.format(len(task_train),len(test),len(val)))
        graph_model = GraphLabelingModel(params, code_labels)
        
        graph_pred_model = TaskModel(graph_model, params).to(params.device)
